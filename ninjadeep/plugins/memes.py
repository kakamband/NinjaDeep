...
from ninjadeep.utils import admin_cmd, register
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern=r"(\w+)say (.*)"))
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern=":/"))
async def kek(keks):
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern=r"coinflip (.*)"))
async def _(event):
...
@ninjadeep.on(admin_cmd(pattern="slap(?: |$)(.*)", outgoing=True))
async def who(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="decide"))
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        if event.fwd_from:
            return
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="cry"))
async def cry(e):
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="insult"))
async def insult(e):
    """ I make you cry !! """
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="cp(?: |$)(.*)"))
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="vapor(?: |$)(.*)"))
async def vapor(vpr):
    """ Vaporize everything! """
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="repo"))
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="str(?: |$)(.*)"))
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="zal(?: |$)(.*)"))
async def zal(zgfy):
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="hi"))
async def hoi(hello):
    """ Greet everyone! """
...
@ninjadeep.on(admin_cmd(pattern=r"hi2"))
async def hi(event):
    if event.fwd_from:
        return
    await event.edit("🌺✨✨🌺✨🌺🌺🌺\n🌺✨✨🌺✨✨🌺✨\n🌺🌺🌺🌺✨✨🌺✨\n🌺✨✨🌺✨✨🌺✨\n🌺✨✨🌺✨🌺🌺🌺\n☁☁☁☁☁☁☁☁")
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="kill"))
...
@ninjadeep.on(events.NewMessage(pattern=r"\.(.*)", outgoing=True))
async def _(event):
