...
# Ported from CatUserBot for ninjadeep
...
@ninjadeep.on(admin_cmd(pattern="trump(?: |$)(.*)", outgoing=True))
@ninjadeep.on(sudo_cmd(pattern="trump(?: |$)(.*)", allow_sudo=True))
...
@ninjadeep.on(admin_cmd(pattern="modi(?: |$)(.*)", outgoing=True))
@ninjadeep.on(sudo_cmd(pattern="modi(?: |$)(.*)", allow_sudo=True))
async def nekobot(event):
    text = event.pattern_match.group(1)
    reply_to_id = event.message
    if event.reply_to_msg_id:
...
@ninjadeep.on(admin_cmd(pattern="cmm(?: |$)(.*)", outgoing=True))
@ninjadeep.on(sudo_cmd(pattern="cmm(?: |$)(.*)", allow_sudo=True))
async def nekobot(event):
    text = event.pattern_match.group(1)
    reply_to_id = event.message
    if event.reply_to_msg_id:
...
@ninjadeep.on(admin_cmd(pattern="kanna(?: |$)(.*)", outgoing=True))
@ninjadeep.on(sudo_cmd(pattern="kanna(?: |$)(.*)", allow_sudo=True))
async def nekobot(event):
    text = event.pattern_match.group(1)
    reply_to_id = event.message
    if event.reply_to_msg_id:
