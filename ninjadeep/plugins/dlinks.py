...
# Re-written by @its_xditya for ninjadeep
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern=r"direct(?: |$)([\s\S]*)"))
@ninjadeep.on(sudo_cmd(allow_sudo=True, pattern=r"direct(?: |$)([\s\S]*)"))
