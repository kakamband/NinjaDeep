...
if Var.TG_BOT_USER_NAME_BF_HER is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if event.query.user_id == bot.uid and query.startswith("NinjaDeep"):
            ...
            result = builder.article(
                title="Stats",
                text=f"**NinjaDeep Stats For [{DEFAULTUSER}](tg://user?id={myid})**\n\n__Bot is functioning normally, master!__\n\n(c) @NinjaDeepSUPPORT",
                buttons=[
                    [custom.Button.inline("Stats", data="statcheck")],
             ...
             NINJABT = USER_BOT_NO_WARN.format(DEFAULTUSER, myid, MESAG)
            ...
            result = builder.article(
                ...
                buttons=[
                    ...
                    [Button.url("Support", "https://t.me/NinjaDeepSUPPORT")],
                ],
            )
        else:
            result = builder.article(
                "Source Code",
                text="**Welcome to NinjaDeep**\n\n`Click below buttons for more`",
                buttons=[
                    ...
                    [
                        ...
                        custom.Button.url(
                            "Deploy 🌀",
                            "https://dashboard.heroku.com/new?template=https%3A%2F%2Fgithub.com%2FLovedeep-ViRk%2FNinjaDeep",
                        ),
                    ],
                    [
                        custom.Button.url(
