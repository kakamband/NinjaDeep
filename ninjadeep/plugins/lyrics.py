...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="lyrics ?(.*)"))
@ninjadeep.on(sudo_cmd(allow_sudo=True, pattern="lyrics ?(.*)"))
async def _(event):
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="glyrics ?(.*)"))
@ninjadeep.on(sudo_cmd(outgoing=True, pattern="glyrics ?(.*)", allow_sudo=True))
