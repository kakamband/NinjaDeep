...
from ninjadeep.plugins.sql_helper.filter_sql import (
    add_filter,
    get_all_filters,
    remove_all_filters,
    remove_filter,
...
@ninjadeep.on(admin_cmd(pattern="savefilter (.*)"))
@ninjadeep.on(sudo_cmd(pattern="savefilter (.*)", allow_sudo=True))
...
@ninjadeep.on(admin_cmd(pattern="listfilters"))
@ninjadeep.on(sudo_cmd(pattern="listfilters", allow_sudo=True))
...
@ninjadeep.on(admin_cmd(pattern="clearfilter (.*)"))
@ninjadeep.on(sudo_cmd(pattern="clearfilter (.*)", allow_sudo=True))
...
@ninjadeep.on(admin_cmd(pattern="clearallfilters"))
@ninjadeep.on(sudo_cmd(pattern="clearallfilters", allow_sudo=True))
