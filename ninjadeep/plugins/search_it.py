...
from ninjadeep.utils import admin_cmd, edit_or_reply, sudo_cmd
...
@ninjadeep.on(admin_cmd(pattern="go (.*)"))
@ninjadeep.on(sudo_cmd(pattern="go (.*)"))
async def _(event):
...
@ninjadeep.on(admin_cmd(pattern="image (.*)"))
@ninjadeep.on(sudo_cmd(pattern="image (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    start = datetime.now()
...
@ninjadeep.on(admin_cmd(pattern="grs"))
@ninjadeep.on(sudo_cmd(pattern="grs", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    start = datetime.now()
