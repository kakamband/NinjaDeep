...
@ninjadeep.on(admin_cmd(pattern="get_ad?(m)in ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="get_ad?(m)in ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@ninjadeep.on(admin_cmd(pattern="get_id"))
@ninjadeep.on(sudo_cmd(pattern="get_id", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if event.reply_to_msg_id:
...
@ninjadeep.on(admin_cmd(pattern="get_bot ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="get_bot ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
