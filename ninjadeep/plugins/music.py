...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="spd(?: |$)(.*)"))
@ninjadeep.on(sudo_cmd(allow_sudo=True, pattern="spd(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="netease(?: |$)(.*)"))
@ninjadeep.on(sudo_cmd(allow_sudo=True, pattern="netease(?: |$)(.*)"))
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="dzd(?: |$)(.*)"))
@ninjadeep.on(sudo_cmd(allow_sudo=True, pattern="dzd(?: |$)(.*)"))
