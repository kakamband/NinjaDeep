...
@ninjadeep.on(admin_cmd(pattern="sg ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="sg ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@ninjadeep.on(admin_cmd(pattern="fakemail ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="fakemail ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    chat = "@fakemailbot"
...
@ninjadeep.on(admin_cmd(pattern="mailid ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="mailid ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    chat = "@fakemailbot"
...
@ninjadeep.on(admin_cmd(pattern="ub ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="ub ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@ninjadeep.on(admin_cmd(pattern="gid ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="gid ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
