...
from ninjadeep.utils import admin_cmd, errors_handler, register, sudo_cmd
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="setgpic"))
@ninjadeep.on(sudo_cmd(outgoing=True, pattern="setgpic", allow_sudo=True))
@errors_handler
...
@ninjadeep.on(admin_cmd("promote(?: |$)(.*)"))
@ninjadeep.on(sudo_cmd(pattern="promote(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="demote(?: |$)(.*)"))
@ninjadeep.on(sudo_cmd(pattern="demote(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@ninjadeep.on(admin_cmd(pattern="(ban|unban) ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="(ban|unban) ?(.*)", allow_sudo=True))
async def _(event):
...
@ninjadeep.on(admin_cmd(pattern="pgs ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="pgs ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
async def muter(moot):
    ...
    try:
        from ninjadeep.modules.sql_helper.gmute_sql import is_gmuted
        from ninjadeep.modules.sql_helper.spam_mute_sql import is_muted
...
@ninjadeep.on(admin_cmd(pattern="affk(?: |$)(.*)"))
@ninjadeep.on(sudo_cmd(pattern="affk(?: |$)(.*)", allow_sudo=True))
@errors_handler
async def promote(promt):
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="gmute(?: |$)(.*)"))
@ninjadeep.on(sudo_cmd(outgoing=True, pattern="gmute(?: |$)(.*)", allow_sudo=True))
@errors_handler
async def gspider(gspdr):
    ...
    try:
        from ninjadeep.modules.sql_helper.gmute_sql import gmute
    except AttributeError:
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="admins$"))
@errors_handler
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="pin(?: |$)(.*)"))
@ninjadeep.on(sudo_cmd(outgoing=True, pattern="pin(?: |$)(.*)"))
@errors_handler
async def pin(msg):
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="kick(?: |$)(.*)"))
@ninjadeep.on(sudo_cmd(outgoing=True, pattern="kick(?: |$)(.*)", allow_sudo=True))
@errors_handler
async def kick(usr):
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="users ?(.*)"))
@errors_handler
