...
@ninjadeep.on(admin_cmd(pattern="reader ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="reader ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@ninjadeep.on(admin_cmd(pattern="aud ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="aud ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@ninjadeep.on(admin_cmd(pattern="instadl ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="instadl ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@ninjadeep.on(admin_cmd(pattern="stats$"))
@ninjadeep.on(sudo_cmd(pattern="stats$", allow_sudo=True))
...
@ninjadeep.on(admin_cmd(pattern="xogame$"))
@ninjadeep.on(sudo_cmd(pattern="xogame$", allow_sudo=True))
...
@ninjadeep.on(admin_cmd(pattern="whisper ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="whisper ?(.*)", allow_sudo=True))
...
@ninjadeep.on(admin_cmd(pattern="crack ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="crack ?(.*)", allow_sudo=True))
async def mod(event):
    if event.fwd_from:
        return
...
@ninjadeep.on(admin_cmd(pattern="checkspam ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="checkspam ?(.*), allow_sudo=True"))
async def _(event):
    bot = "@SpamBot"
    if event.fwd_from:
        return
...
@ninjadeep.on(admin_cmd(pattern="gitdl ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="gitdl ?(.*), allow_sudo=True"))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
    ...
    async with event.client.conversation(chat) as conv:
        ...
        await x.edit(
            "Downloaded by [ninjadeep](t.me/ninjadeepSupport), via @gitdownloadbot"
        )


@ninjadeep.on(admin_cmd(pattern="imusic ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="imusic ?(.*)", allow_sudo=True))
async def tel(event):
    if event.fwd_from:
        return
...
@ninjadeep.on(admin_cmd(pattern="font ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="font ?(.*)", allow_sudo=True))
async def _(event):
    bot = "@fontsgenbot"
    if event.fwd_from:
        return
