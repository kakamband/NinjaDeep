...
@ninjadeep.on(admin_cmd(outgoing=True, pattern=r"mute ?(\d+)?"))
@ninjadeep.on(sudo_cmd(allow_sudo=True, pattern=r"mute ?(\d+)?"))
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern=r"unmute ?(\d+)?"))
@ninjadeep.on(sudo_cmd(allow_sudo=True, pattern=r"unmute ?(\d+)?"))
...
@ninjadeep.on(admin_cmd(incoming=True))
