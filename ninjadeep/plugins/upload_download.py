...
from ninjadeep import CMD_HELP, LOGS, TEMP_DOWNLOAD_DIRECTORY
...
@ninjadeep.on(admin_cmd(pattern=r"dl(?: |)(.*)", outgoing=True))
@ninjadeep.on(sudo_cmd(pattern=r"dl(?: |)(.*)", allow_sudo=True))
...
@ninjadeep.on(admin_cmd(pattern=r"uploadir (.*)", outgoing=True))
@ninjadeep.on(sudo_cmd(pattern=r"uploadir (.*)", allow_sudo=True))
...
@ninjadeep.on(admin_cmd(pattern=r"ul (.*)", outgoing=True))
@ninjadeep.on(sudo_cmd(pattern=r"ul (.*)", allow_sudo=True))
...
@ninjadeep.on(admin_cmd(pattern=r"uploadas(stream|vn|all) (.*)", outgoing=True))
@ninjadeep.on(sudo_cmd(pattern=r"uploadas(stream|vn|all) (.*)", allow_sudo=True))
