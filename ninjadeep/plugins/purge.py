...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="purgeme"))
@errors_handler
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="del"))
@errors_handler
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="edit"))
@errors_handler
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="sd"))
@errors_handler
