...
@ninjadeep.on(admin_cmd(pattern="mslap ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="mslap ?(.*)", allow_sudo=True))
async def who(event):
    if event.fwd_from:
        return
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="mrape"))
@ninjadeep.on(sudo_cmd(allow_sudo=True, pattern="mrape"))
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="mshe"))
@ninjadeep.on(sudo_cmd(allow_sudo=True, pattern="mshe"))
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="mabuse"))
@ninjadeep.on(sudo_cmd(allow_sudo=True, pattern="mabuse"))
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="mruns"))
@ninjadeep.on(sudo_cmd(allow_sudo=True, pattern="mruns"))
async def fuckedd(abusehard):
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="minsult$"))
@ninjadeep.on(sudo_cmd(allow_sudo=True, pattern="minsult$"))
async def proo(pros):
...
@ninjadeep.on(admin_cmd(pattern=r"foryou$", outgoing=True))
@ninjadeep.on(sudo_cmd(pattern=r"foryou$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="kozhi"))
@ninjadeep.on(sudo_cmd(allow_sudo=True, pattern="kozhi"))
