...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="magisk"))
@ninjadeep.on(sudo_cmd(pattern="magisk"))
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
@ninjadeep.on(sudo_cmd(pattern=r"device(?: |$)(\S*)"))
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)"))
@ninjadeep.on(sudo_cmd(pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
@ninjadeep.on(sudo_cmd(pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
@ninjadeep.on(sudo_cmd(pattern=r"twrp(?: |$)(\S*)"))
