...
@ninjadeep.on(admin_cmd(pattern=r"(set|get|del) var (.*)", outgoing=True))
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern=r"usage(?: |$)"))
@ninjadeep.on(sudo_cmd(allow_sudo=True, pattern=r"usage(?: |$)"))
...
@ninjadeep.on(admin_cmd(pattern="info heroku"))
@ninjadeep.on(sudo_cmd(pattern="info heroku", allow_sudo=True))
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern=r"logs"))
@ninjadeep.on(sudo_cmd(allow_sudo=True, pattern=r"logs"))
async def _(givelogs):
    ...
    with open("logs-NinjaDeep.txt", "w") as log:
