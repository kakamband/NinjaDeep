...
from ninjadeep.plugins.sql_helper.snips_sql import (
    add_snip,
    get_all_snips,
    get_snips,
    remove_snip,
...
@ninjadeep.on(events.NewMessage(pattern=r"\#(\S+)", outgoing=True))
...
@ninjadeep.on(admin_cmd(pattern="snipl"))
...
@ninjadeep.on(admin_cmd(pattern=r"snipd (\S+)"))
