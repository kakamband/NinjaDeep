...
from ninjadeep.plugins.sql_helper.ghdb_sql import (
    add_channel,
    get_all_channels,
    in_channels,
    rm_channel,
...
@ninjadeep.on(admin_cmd(pattern="forward ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="forward ?(.*)", allow_sudo=True))
...
@ninjadeep.on(admin_cmd(pattern="broadcast ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="broadcast ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.is_reply:
...
@ninjadeep.on(admin_cmd(pattern="add ?(.*)"))
...
@ninjadeep.on(admin_cmd(pattern="rm ?(.*)"))
...
@ninjadeep.on(admin_cmd(pattern="listchannels"))
@ninjadeep.on(sudo_cmd(pattern="listchannels", allow_sudo=True))
...
@ninjadeep.on(admin_cmd(pattern="search ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="search ?(.*)", allow_sudo=True))
