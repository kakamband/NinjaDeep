...
async def amireallyalive(alive):
    ...
    if ALV_PIC:
        ...
        tele += "` ➥🔹**Deploy** : [Deploy NinjaDeep](https://heroku.com/deploy?template=https://github.com/Lovedeep-ViRk/NinjaDeep)"
    ...
    with BytesIO() as sticker:
        ...
        await borg.send_message(
            ...
            "` ➥🔹**Deploy** : [Deploy NinjaDeep](https://heroku.com/deploy?template=https://github.com/Lovedeep-ViRk/NinjaDeep)",
            link_preview=False,
        )
