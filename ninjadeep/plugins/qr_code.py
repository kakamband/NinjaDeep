...
@ninjadeep.on(admin_cmd(pattern="getqr"))
@ninjadeep.on(sudo_cmd(pattern="getqr", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    start = datetime.now()
...
@ninjadeep.on(admin_cmd(pattern="makeqr ?(.*)"))
@ninjadeep.on(sudo_cmd(pattern="makeqr ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    start = datetime.now()
