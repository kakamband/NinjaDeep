...
@ninjadeep.on(admin_cmd(pattern="repcf", outgoing=True))
@ninjadeep.on(sudo_cmd(pattern="repcf", allow_sudo=True))
...
@ninjadeep.on(admin_cmd(pattern="addcf", outgoing=True))
@ninjadeep.on(sudo_cmd(pattern="addcf", allow_sudo=True))
...
@ninjadeep.on(admin_cmd(pattern="remcf", outgoing=True))
@ninjadeep.on(sudo_cmd(pattern="remcf", allow_sudo=True))
