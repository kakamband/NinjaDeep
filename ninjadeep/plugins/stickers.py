...
KANGING_STR = [
    "Using NinjaDeep to kang this sticker...",
    "Plagiarising hehe...",
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="kang"))
@ninjadeep.on(sudo_cmd(pattern="kang", allow_sudo=True))
async def kang(args):
    ...
    if photo:
        ...
        packnick = f"@{user.username}'s NinjaDeep Vol.{pack}"
        cmd = "/newpack"
        file = io.BytesIO()
...
@ninjadeep.on(admin_cmd(outgoing=True, pattern="stkrinfo"))
@ninjadeep.on(sudo_cmd(pattern="stkrinfo", allow_sudo=True))
