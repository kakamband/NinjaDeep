...
@ninjadeep.on(admin_cmd(pattern="sthink (.*)"))
...
@ninjadeep.on(admin_cmd(pattern="sdick (.*)"))
...
@ninjadeep.on(admin_cmd(pattern="sfrog (.*)"))
...
@ninjadeep.on(admin_cmd(pattern="sputin (.*)"))
...
@ninjadeep.on(admin_cmd(pattern="sdead (.*)"))
...
@ninjadeep.on(admin_cmd(pattern="strump (.*)"))
...
@ninjadeep.on(admin_cmd(pattern="schina (.*)"))
...
@ninjadeep.on(admin_cmd(pattern=r"spika"))
async def kakashi(pikachu):
    await pikachu.edit(F)


@ninjadeep.on(admin_cmd(pattern=r"sshit"))
async def kakashi(shit):
    await shit.edit(G)


@ninjadeep.on(admin_cmd(pattern=r"sxx"))
async def kakashi(saxy):
    await saxy.edit(H)


@ninjadeep.on(admin_cmd(pattern=r"sporn"))
